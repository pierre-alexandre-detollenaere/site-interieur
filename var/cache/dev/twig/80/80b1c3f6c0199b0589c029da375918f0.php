...
class __TwigTemplate_09806a986fb261421c7c668c6174d29b extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["auteur"]) {
            ...
            echo "</td>
                    <td>
                        <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_auteur_update", ["id" => twig_get_attribute($this->env, $this->source, $context["auteur"], "id", [], "any", false, false, false, 29)]), "html", null, true);
            echo "\">
                            <i class=\"fas fa-edit mx-1 text-success\"></i>
                        </a>
                        <a href=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_auteur_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["auteur"], "id", [], "any", false, false, false, 32)]), "html", null, true);
            echo "\">
...
";
    ...
    {
        return array (  136 => 38,  124 => 32,  118 => 29,  113 => 27,  109 => 26,  106 => 25,  98 => 23,  96 => 22,  92 => 20,  88 => 19,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
        ...
        <tbody>
            {% for auteur in auteurs %}
                <tr>
                    ...
                    <td>{{ auteur.prenom }}</td>
                    <td>
                        <a href=\"{{ path('app_auteur_update', {id: auteur.id}) }}\">
                            <i class=\"fas fa-edit mx-1 text-success\"></i>
                        </a>
                        <a href=\"{{ path('app_auteur_delete', {id: auteur.id}) }}\">
                            <i class=\"fas fa-trash text-danger\"></i>
                        </a>
                    </td>
                </tr>
